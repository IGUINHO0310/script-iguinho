...
local Window = OrionLib:MakeWindow({Name = "Ig dutra", HidePremium = false, IntroText = "", SaveConfig = true, ConfigFolder = "Ig dutra"})
...
if World2 and World1 then
    ...
    local Section = M:AddSection({
        Name = "Farm Secundario"
    })

    M:AddParagraph("Redeem Code","Click no botão pra resgatar todos codigos.")
